...
namespace WhiteLagoon.Web.Controllers
{
    public class BookingController : Controller
    {
        ...
        public BookingController(IWebHostEnvironment webHostEnvironment, IVillaNumberService villaNumberService, IVillaService villaService, IBookingService bookingService, UserManager<ApplicationUser> userManager)
        {
        ...
        public IActionResult FinalizeBooking(int villaId, string checkInDate, int nights)
        {
            ...
            DateOnly checkInDateOnly = DateOnly.Parse(checkInDate);
        ...
        public IActionResult BookingDetails(int bookingId)
        {
            ...
            if (bookingFromDb.VillaNumber == 0 && bookingFromDb.Status == SD.StatusApproved)
            {
                ...
                bookingFromDb.VillaNumbers = _villaNumberService.GetAllVillaNumbers().Where(v => v.VillaId == bookingFromDb.VillaId && availableVillaNumber.Any(x => x == v.Villa_Number)).ToList();
            }
        ...
        public IActionResult GenerateInvoice(int id, string downloadType)
        {
            ...
            WTableStyle tableStyle = document.AddTableStyle("CustomStyle");
        ...
        private List<int> AssignAvailableVillaNumberByVilla(int villaId)
        {
            ...
            var villaNumbers = _villaNumberService.GetAllVillaNumbers().Where(v => v.VillaId == villaId);
